...
router.register(r"contributions_musical_work", views.ContributionMusicalWorkViewSet)
router.register(r"contributions_section", views.ContributionSectionViewSet)
