...
urlpatterns = [
    ...
    url(r'^collectionofsources/new/$', CreateCollectionOfSourcesView.as_view(), name='collectionofsources'),
    url(r'^musicalwork/new/$', CreateMusicalWorkView.as_view(), name='musicalwork'),
