...
from database.views.research_corpus import CreateResearchCorpusFileView
...
urlpatterns = [
    ...
    url(r'^researchcorpus/new/$', CreateResearchCorpusFileView.as_view(), name='researchcorpus_new'),
]
