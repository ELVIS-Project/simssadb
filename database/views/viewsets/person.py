...
class PersonViewSet(GenericModelViewSet):
    ...
    detail_fields = ['birth_location',
                     'death_location',
                     'date_of_birth',
                     'date_of_death',
                     'published']
    detailed_attributes = [DetailedAttribute(attribute_name='works_composed'),
                           DetailedAttribute(attribute_name='works_arranged'),
                           DetailedAttribute(attribute_name='works_authored'),
                           DetailedAttribute(
                                   attribute_name='works_improvised'),
                           DetailedAttribute(attribute_name='works_performed'),
                           DetailedAttribute(
                                   attribute_name='works_transcribed'),
                           ...
                           DetailedAttribute(
                                   attribute_name='sections_improvised'),
                           DetailedAttribute(attribute_name='sections_performed'),
                           DetailedAttribute(
                                   attribute_name='sections_transcribed'),
                           ...
                           DetailedAttribute(
                                   attribute_name='parts_improvised'),
                           DetailedAttribute(attribute_name='parts_performed'),
                           DetailedAttribute(
                                   attribute_name='parts_transcribed')]
