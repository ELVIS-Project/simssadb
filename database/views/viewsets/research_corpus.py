...
class ResearchCorpusViewSet(GenericModelViewSet):
    queryset = ResearchCorpus.objects.all().prefetch_related(
        "features__instance_of_feature",
    ...
    detailed_attributes = [
        DetailedAttribute(
            attribute_name="files", fields=["file_type", "file_size", "source"]
        ),
        DetailedAttribute(attribute_name="features", fields=["feature_of"]),
    ]
