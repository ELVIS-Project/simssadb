# Generated by Django 2.2.2 on 2019-08-12 18:13
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date_created', models.DateTimeField(auto_now_add=True, help_text='The date this entry was created')),
                ('date_updated', models.DateTimeField(auto_now=True, help_text='The date this entry was updated')),
                ('persons', models.CharField(blank=True, help_text='The person(s) that validated a file', max_length=512, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('sacred_or_secular', models.NullBooleanField(default=None, help_text='Leave blank if not applicable.')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('language_of_text', models.CharField(blank=True, help_text='The language of the text of this Source', max_length=200, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('persons', models.CharField(blank=True, help_text='The person(s) that validated a file', max_length=512, null=True)),
                ('notes', models.TextField(blank=True, help_text='Any extra notes or remarks the user wishes to provide', null=True)),
                ('validator_sofware', models.ForeignKey(blank=True, help_text='The Software that was used in this Validation Workflow', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='validation_workflows', to='database.Software')),
            ],
            options={
        ...
        migrations.AddField(
            model_name='musicalwork',
            name='related_works',
            field=models.ManyToManyField(blank=True, help_text='MusicalWorks that are related to this MusicalWork, for instance, one is an arrangement of the other', related_name='_musicalwork_related_works_+', to='database.MusicalWork'),
        ),
        migrations.AddField(
            model_name='file',
            name='instantiates',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('sources', models.ManyToManyField(help_text='Sources that belong to this Archive', related_name='in_archive', to='database.Source')),
            ],
            options={
                'db_table': 'archive',
                'abstract': False,
        ...
        migrations.AddConstraint(
            model_name='contributionmusicalwork',
            constraint=models.CheckConstraint(check=(models.Q(models.Q(models.Q(('date_range_year_only__startswith__isnull', False), ('date_range_year_only__endswith__isnull', False)), ('date_range_year_only__isnull', True), _connector='OR')),), name='bounds_not_null'),
        ),
    ]
