    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('source', models.ForeignKey(help_text='The Source that this ourceInstantiation instantiates', on_delete=django.db.models.deletion.CASCADE, related_name='source_instantiations', to='database.Source')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date_created', models.DateTimeField(auto_now_add=True, help_text='The date this entry was created')),
                ('date_updated', models.DateTimeField(auto_now=True, help_text='The date this entry was updated')),
                ('file_type', models.CharField(help_text='The format of the ile', max_length=100)),
                ('file_size', models.PositiveIntegerField(blank=True, help_text='The size of the File n bytes', null=True)),
                ...
                ('extra_metadata', django.contrib.postgres.fields.jsonb.JSONField(blank=True, help_text='Any extra metadata associated with he File', null=True)),
                ...
                ('encoded_with', models.ForeignKey(blank=True, help_text='The Encoder of his File', null=True, on_delete=django.db.models.deletion.PROTECT, to='database.Encoder')),
                ('manifests', models.ForeignKey(help_text='The SourceInstantiation anifested by this ext File', on_delete=django.db.models.deletion.CASCADE, related_name='manifested_by_text_files', to='database.SourceInstantiation')),
                ('validated_by', models.ForeignKey(blank=True, help_text='The Validator of this file', null=True, on_delete=django.db.models.deletion.SET_NULL, to='database.Validator')),
            ],
            options={
                'db_table': 'text_file',
                'abstract': False,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('encoded_with', models.ForeignKey(blank=True, help_text='The Encoder of his File', null=True, on_delete=django.db.models.deletion.PROTECT, to='database.Encoder')),
                ('instruments_used', models.ManyToManyField(blank=True, help_text='The Instruments used n this Symbolic ile', related_name='sym_files', to='database.Instrument')),
                ('manifests', models.ForeignKey(help_text='The SourceInstantiation anifested by this ymbolic File', on_delete=django.db.models.deletion.CASCADE, related_name='manifested_by_sym_files', to='database.SourceInstantiation')),
                ('validated_by', models.ForeignKey(blank=True, help_text='The Validator of this file', null=True, on_delete=django.db.models.deletion.SET_NULL, to='database.Validator')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('files', models.ManyToManyField(help_text='The Symbolic Music Files that his Research Corpus contains', related_name='in_corpora', to='database.SymbolicMusicFile')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('encoded_with', models.ForeignKey(blank=True, help_text='The Encoder of his File', null=True, on_delete=django.db.models.deletion.PROTECT, to='database.Encoder')),
                ('manifests', models.ForeignKey(help_text='The SourceInstantiation anifested by these images', on_delete=django.db.models.deletion.CASCADE, related_name='manifested_by_image_files', to='database.SourceInstantiation')),
                ('validated_by', models.ForeignKey(blank=True, help_text='The Validator of this file', null=True, on_delete=django.db.models.deletion.SET_NULL, to='database.Validator')),
            ],
            options={
                'db_table': 'image_file',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('symbolic_music_file', models.ForeignKey(help_text='The Symbolic Music File that the features were extracted from', on_delete=django.db.models.deletion.CASCADE, related_name='feature_files', to='database.SymbolicMusicFile')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('feature_of', models.ForeignKey(help_text='The Symbolic File from which the feature was extracted', on_delete=django.db.models.deletion.CASCADE, related_name='features', to='database.SymbolicMusicFile')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('contributed_to_part', models.ForeignKey(blank=True, help_text='The Part that the Person contributed to', null=True, on_delete=django.db.models.deletion.CASCADE, related_name='contributions', to='database.Part')),
                ('contributed_to_section', models.ForeignKey(blank=True, help_text='The Section that the Person contributed to', null=True, on_delete=django.db.models.deletion.CASCADE, related_name='contributions', to='database.Section')),
                ('contributed_to_work', models.ForeignKey(blank=True, help_text='The Musical Work that the Person contributed to', null=True, on_delete=django.db.models.deletion.CASCADE, related_name='contributions', to='database.MusicalWork')),
                ('location', models.ForeignKey(blank=True, help_text='The location in which this contribution happened', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='contributions', to='database.GeographicArea')),
                ('person', models.ForeignKey(help_text='The Person that contributed to a Musical Work, Section or Part', on_delete=django.db.models.deletion.PROTECT, related_name='contributions', to='database.Person')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('encoded_with', models.ForeignKey(blank=True, help_text='The Encoder of his File', null=True, on_delete=django.db.models.deletion.PROTECT, to='database.Encoder')),
                ('manifests', models.ForeignKey(help_text='The SourceInstantiation manifested by this Audio File', on_delete=django.db.models.deletion.CASCADE, related_name='manifested_by_audio_files', to='database.SourceInstantiation')),
                ('validated_by', models.ForeignKey(blank=True, help_text='The Validator of this file', null=True, on_delete=django.db.models.deletion.SET_NULL, to='database.Validator')),
            ],
            options={
                'db_table': 'audio_file',
        ...
        migrations.AddConstraint(
            ...
            constraint=models.CheckConstraint(check=models.Q(models.Q(('user__isnull', True), ('software__isnull', False)), models.Q(('user__isnull', False), ('software__isnull', True)), _connector='OR'), name='validator_user_xor_software'),
        ),
        migrations.AddIndex(
            model_name='section',
        ...
        migrations.AddConstraint(
            model_name='part',
            constraint=models.CheckConstraint(check=models.Q(models.Q(('section__isnull', True), ('_musical_work__isnull', False)), models.Q(('section__isnull', False), ('_musical_work__isnull', True)), _connector='OR'), name='work_xor_section'),
        ),
        migrations.AddIndex(
        ...
        migrations.AddConstraint(
            model_name='encoder',
            constraint=models.CheckConstraint(check=models.Q(models.Q(('user__isnull', True), ('software__isnull', False)), models.Q(('user__isnull', False), ('software__isnull', True)), _connector='OR'), name='encoder_user_xor_software'),
        ),
