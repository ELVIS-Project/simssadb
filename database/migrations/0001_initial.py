    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('search_document', django.contrib.postgres.search.SearchVectorField(blank=True, null=True)),
                ('contributors', models.ManyToManyField(blank=True, help_text='The persons that contributed to the creation of this Section', through='database.ContributionSection', to='database.Person')),
        ...
        migrations.AddField(
            model_name='file',
            name='instantiates',
            field=models.ForeignKey(help_text='The SourceInstantiation anifested by this File', on_delete=django.db.models.deletion.CASCADE, related_name='files', to='database.SourceInstantiation'),
        ),
        migrations.AddField(
            model_name='file',
        ...
        migrations.AddField(
            model_name='contributionsection',
            name='contributed_to_section',
            field=models.ForeignKey(help_text='The Section that the Person contributed to', on_delete=django.db.models.deletion.CASCADE, related_name='contributions', to='database.Section'),
        ),
        migrations.AddField(
            model_name='contributionsection',
            name='location',
        ...
        migrations.AddField(
            model_name='contributionsection',
            name='person',
            field=models.ForeignKey(help_text='The Person that contributed to a Section', on_delete=django.db.models.deletion.PROTECT, related_name='contributions_sections', to='database.Person'),
        ),
        migrations.AddField(
